...
ImuError2::ImuError2(const yac::ImuMeasurementDeque &imuMeasurements,
...
int ImuError2::redoPreintegration(
...
// Propagates pose, speeds and biases with given IMU measurements.
int ImuError2::propagation(const yac::ImuMeasurementDeque &imuMeasurements,
...
bool ImuError2::Evaluate(double const *const *parameters,
                         double *residuals,
...
bool ImuError2::EvaluateWithMinimalJacobians(double const *const *parameters,
                                            double *residuals,
                                            double **jacobians,
