#ifndef YAC_COMMON_TIME_HPP
#define YAC_COMMON_TIME_HPP
 ...
 * clock time.
 *
 * yac::TimeBase provides most of its functionality.
 */
...
public:
   ...
   */
  static bool waitForValid(const yac::WallDuration &timeout);
};
