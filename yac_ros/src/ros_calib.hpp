...
//   typedef message_filters::sync_policies::ExactTime<ImageMsg, ImageMsg>
//       ImageSyncPolicy;
...
//       : config{config_}, calib_data{calib_data_}, cam0_sub{*config.ros_nh,
//                                                            config.cam0_topic,
//                                                            30},
...
//     poses_init =
//         calib_init_poses<CAMERA>(calib_data.target,
//         calib_data.cam_params[0]);
...
//     // Draw NBV
//     nbv_draw<CAMERA>(calib_data.target, calib_data.cam_params[0], T_FC0,
//     image);
//
...
//       delete target_grid;
//     }
//     target_grid = nbv_target_grid<CAMERA>(calib_data.target,
//                                           calib_data.cam_params[0],
//                                           nbv_pose);
...
//       : config{config_}, calib_data{calib_data_}, cam0_sub_{*config.ros_nh,
//                                                             config.cam0_topic,
//                                                             30},
...
//     // clang-format off
//     image_transport::ImageTransport it(*config.ros_nh);
//     imu0_sub_ = config.ros_nh->subscribe(config_.imu0_topic, 1000,
//     &calib_vi_init_node_t::imu0_callback, this);
//     image_sync_.registerCallback(&calib_vi_init_node_t::image_callback,
//     this);
//     // clang-format on
//     // -- Rviz marker publisher
//     rviz_pub_ =
//         config.ros_nh->advertise<visualization_msgs::Marker>("/yac_ros/rviz",
//                                                              0);
//
//     // Configure detector
...
//
//     // Initialize poses
//     poses_init = calib_init_poses<pinhole_radtan4_t>(calib_data.target,
//                                                      calib_data.cam_params[0]);
//
//     // Configure estimator
