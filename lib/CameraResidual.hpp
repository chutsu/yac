...
public:
  ...
  create(const std::shared_ptr<CameraGeometry> &camera,
    ...
    return std::make_shared<CameraResidual>(camera,
                                            param_ptrs,
                                            param_types,
                                            z,
                                            covar);
