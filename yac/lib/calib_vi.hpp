...
//       J(jacobians[0]); J.setZero(); J.block(0, 0, 6, 6) = J_min;
//     }
//
//     return true;
//   }
...
//         ceres::ResidualBlockId imu_error_id_,
//         ImuError *imu_error_,
...
//           {}
//
//     void calculate_reproj_errors(const int cam_idx, std::vector<double>
//     &errs) {
...
//     problem->SetParameterization(cam_ext->param.data(),
...
//     problem->SetParameterization(imu_ext->param.data(),
//     &pose_parameterization);
//
//     if (fix) {
...
//   }
//
//   void add_sensor_pose(const timestamp_t ts,
//                        const mat4_t &T_WS,
//                        const bool fix = false) {
...
//
//       auto error =
//           new reproj_fiducial_error_t<pinhole_radtan4_t>(ts_i,
//                                                          ts_j,
//                                                          cam_res,
//                                                          tag_id,
//                                                          corner_idx,
...
//     // the provided `T_WS_`, this is because in the scenario where we are
//     using
//     // AprilGrid, as a fiducial target, we actually have a better estimation
//     of
...
//           pose_j{pose_j_}, sb_i{sb_i_}, sb_j{sb_j_}, cam_exts{cam_exts_},
//           cam_params{cam_params_}, imu_exts{imu_exts_},
//           time_delay{time_delay_}, imu_error_id{imu_error_id_},
//           imu_error{imu_error_}, reproj_error_ids{reproj_error_ids_},
//           reproj_errors{reproj_errors_} {}
//
//     void calculate_reproj_errors(const int cam_idx, std::vector<double>
//     &errs) {
...
//
//       auto error =
//           new reproj_error_td_t<pinhole_radtan4_t>(ts_i,
//                                                    ts_j,
//                                                    cam_res,
//                                                    tag_id,
//                                                    corner_idx,
...
//     covar_est.GetCovarianceBlockInTangentSpace(T_BS, T_BS,
//     T_BS_covar.data()); covar_est.GetCovarianceBlock(td, td,
//     td_covar.data());
//
...
//       fprintf(csv, "%s,%s,", cam->proj_model.c_str(),
//       cam->dist_model.c_str()); fprintf(csv, "%f,%f,%f,%f,", proj(0),
//       proj(1), proj(2), proj(3)); fprintf(csv, "%f,%f,%f,%f\n", dist(0),
