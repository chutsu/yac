#ifndef AUTOCAL_CERES_REPROJECTION_ERROR_BASE_HPP
#define AUTOCAL_CERES_REPROJECTION_ERROR_BASE_HPP
...
/// \brief Calibration reprojection error base class.
template <int... T>
class ReprojErrorFiducialPoseBase_ : public ReprojectionErrorBase_<T...> {
public:
  typedef ReprojectionErrorBase_<T...> base_t;
  typedef typename ReprojectionErrorBase_<T...>::ceres_base_t ceres_base_t;
...
typedef ReprojErrorFiducialPoseBase_<2 /* number of residuals */,
																		 7 /* size of T_WS */,
																		 7 /* size of T_WF */,
																		 7 /* size of T_BS */,
																		 7 /* size of T_BC */,
																		 8 /* size of cam params */>
    ReprojErrorFiducialPoseBase;

} // namespace autocal
#endif /* AUTOCAL_CERES_REPROJECTION_ERROR_BASE_HPP */
