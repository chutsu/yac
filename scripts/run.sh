...
# RUN_CMD="test_util_core --target test_ctraj_sandbox"
...
# RUN_CMD="test_calib_residuals --target test_pose_residual"
...
# RUN_CMD="calib_inspect '/home/chutsu/projects/yac/yac/configs/calib-yac.yaml' /data/euroc/imu_april"
