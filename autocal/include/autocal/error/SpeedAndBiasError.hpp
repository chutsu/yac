#ifndef AUTOCAL_CERES_SPEEDANDBIASERROR_HPP
#define AUTOCAL_CERES_SPEEDANDBIASERROR_HPP
...
public:
  ...
  SpeedAndBiasError(const autocal::SpeedAndBias &measurement,
  ...
  SpeedAndBiasError(const autocal::SpeedAndBiases &measurement,
  ...
  /// @param[in] measurement The measurement.
  void setMeasurement(const autocal::SpeedAndBias &measurement) {
  ...
  const autocal::SpeedAndBias &measurement() const { return measurement_; }
...
protected:
  // the measurement
  autocal::SpeedAndBias measurement_; ///< The (9D) measurement.
...
#endif /* AUTOCAL_CERES_SPEEDANDBIASERROR_HPP */
