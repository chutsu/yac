// #ifndef AUTOCAL_CORE_HPP
// #define AUTOCAL_CORE_HPP
//
// /*****************************************************************************
...
//
// /* Pseudo inverse of a PSD matrix using eigen-decomposition */
// matx_t pinv_symm(const matx_t &A, int *rank=nullptr);
//
// /** Rank of matrix A **/
// long int rank(const matx_t &A);
//
// /** Check whether matrix A is full rank **/
...
//  */
// mat4_t lookat(const vec3_t &eye,
//               const vec3_t &target,
...
//
// /**
//  * Flatten the 4x4 homogeneous transformation matrix `T` to an array `data`.
//  */
...
//   std::deque<std::string> key_order;
//
//   profiler_t() {}
//
...
//
//   void print() {
//     double total_elapse = 0.0;
//     for (const auto &key : key_order) {
// 			printf("[%s]: %.4fs\n", key.c_str(), record[key]);
// 			total_elapse += record[key];
//     }
