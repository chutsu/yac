...
//         goto start;
//       }
//       // if (check_fully_observable(target, cam0_geom, cam1, T_FC1) ==
//       false)
//       {
//       //   pan_trajs.clear();
//       //   scale -= 0.05;
...
//   const auto grids = calib_simulate(target, nbv_poses, cam_geom,
//   cam_params);
//
...
// int nbv_find(const calib_target_t &target, calib_data_t &data, mat4_t
// &T_FC0)
// {
//   assert(data.problem);
//
...
//
//     // Check covar_y
//     if (covar_y(0, 0) < 0 || covar_y(1, 1) < 0 || covar_y.determinant() <
//     0)
//     {
