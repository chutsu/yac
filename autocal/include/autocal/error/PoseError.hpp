#ifndef AUTOCAL_CERES_ERROR_POSE_ERROR_HPP
#define AUTOCAL_CERES_ERROR_POSE_ERROR_HPP
...
public:
  ...
  PoseError(const autocal::Transformation &measurement,
  ...
  /// @param[in] measurement The measurement.
  void setMeasurement(const autocal::Transformation &measurement) {
  ...
  const autocal::Transformation &measurement() const {
    return measurement_;
  }
...
protected:
  // the measurement
  autocal::Transformation measurement_; ///< The pose measurement.
...
#endif /* AUTOCAL_CERES_ERROR_POSE_ERROR_HPP */
