#include "autocal/error/SpeedAndBiasError.hpp"

namespace autocal {

SpeedAndBiasError::SpeedAndBiasError(const autocal::SpeedAndBias &measurement,
                                     const information_t &information) {
  setMeasurement(measurement);
  setInformation(information);
}

SpeedAndBiasError::SpeedAndBiasError(const autocal::SpeedAndBiases &measurement,
...
bool SpeedAndBiasError::EvaluateWithMinimalJacobians(
  ...
  // compute error
  Eigen::Map<const autocal::SpeedAndBias> estimate(parameters[0]);
  autocal::SpeedAndBias error = measurement_ - estimate;
