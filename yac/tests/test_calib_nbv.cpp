...
//   const timestamp_t ts_start = 0;
//   const timestamp_t ts_end = 5e9;
//   calib_figure8_trajs<pinhole_radtan4_t>(target,
//                                          cameras[0],
//                                          cameras[1],
//                                          T_BC0,
//                                          T_BC1,
...
//   const camera_params_t cam_params{id,
//                                    cam_idx,
//                                    cam_res,
//                                    proj_model,
//                                    dist_model,
...
//   // Setup nbv poses
//   const calib_target_t target{"aprilgrid", 6, 6, 0.088, 0.3};
//   const mat4s_t poses = calib_init_poses<pinhole_radtan4_t>(target,
//   cam_params); const std::string save_path = "/tmp/calib_poses.csv";
//   save_poses(save_path, poses);
//
//   for (const auto &T_FC : poses) {
//     cv::Mat image(cam_res[1], cam_res[0], CV_8UC3, cv::Scalar(255, 255,
//     255)); nbv_draw<pinhole_radtan4_t>(target, cam_params, T_FC, image);
...
//   const vec4_t dist_params{0.0, 0.0, 0.0, 0.0};
//   camera_params_t
//       cam0{0, 0, cam_res, proj_model, dist_model, proj_params, dist_params};
//   camera_params_t
//       cam1{1, 1, cam_res, proj_model, dist_model, proj_params, dist_params};
