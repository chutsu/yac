...
// void Map::saveCameraParams(FILE *csv_file,
//                            const size_t frame_index,
//                            const size_t cam_idx) {
//   vecx_t data = getCameraParameterEstimate(cam_idx);
//
//   fprintf(csv_file, "%zu,", frame_index);
...
// }
//
// void Map::saveSensorCameraPose(FILE *csv_file,
//                                const size_t frame_index,
//                                const size_t cam_idx) {
...
// }
//
// void Map::saveFiducialPose(FILE *csv_file, const size_t frame_index) {
...
// }
//
// void Map::saveTimeDelay(FILE *csv_file, const size_t frame_index) {
//   fprintf(csv_file, "%zu,", frame_index);
...
// }
//
// void Map::saveSensorPose(FILE *csv_file, const size_t frame_index) {
...
// }
//
// void Map::saveSpeedBias(FILE *csv_file, const size_t frame_index) {
...
// }
//
// void Map::saveEstimates(const size_t frame_index) {
//   saveCameraParams(cam0_file_, frame_index, 0);
//   saveCameraParams(cam1_file_, frame_index, 1);
//   saveSensorCameraPose(T_SC0_file_, frame_index, 0);
//   saveSensorCameraPose(T_SC1_file_, frame_index, 1);
//   saveFiducialPose(T_WF_file_, frame_index);
//   saveTimeDelay(td_file_, frame_index);
//   saveSensorPose(T_WS_file_, frame_index);
//   saveSpeedBias(sb_file_, frame_index);
// }
...
std::shared_ptr<ParameterBlock> Map::parameterBlockPtr(uint64_t parameterBlockId) {
