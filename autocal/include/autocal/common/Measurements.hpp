#ifndef AUTOCAL_MEASUREMENTS_HPP
#define AUTOCAL_MEASUREMENTS_HPP
...
struct Measurement {
  ...
  autocal::Time timeStamp;   ///< Measurement timestamp
  ...
  Measurement(const autocal::Time &timeStamp,
 ...
 */
struct FrameData {
  typedef std::shared_ptr<autocal::FrameData> Ptr;
...
#endif // AUTOCAL_MEASUREMENTS_HPP
